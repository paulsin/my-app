...
const IndividualPropertymessageComponent = (props) => {
    ...
    var namewidget=<input type="text" className="form-control" required onChange={(e) =>  setOwnername(e.target.value)}/> 
    var messagewidget=<textarea className="form-control" onChange={(e) =>  setMessage(e.target.value)} /> 
    var ownerdatasavebuttonwidget=<button type="submit" className="btn btn-danger" onClick={submitOwnerdata}>Request Owner Details</button>  
